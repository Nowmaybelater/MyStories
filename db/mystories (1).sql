...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 11 mai 2022 à 11:01
...
--
-- Déchargement des données de la table `player_points`
--

INSERT INTO `player_points` (`id_user`, `id_story`, `points`, `death`) VALUES
(1, 1, 1, 0);
...
--
ALTER TABLE `chapters`
  MODIFY `id_chapter` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
