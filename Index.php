...
<main>
  <div id="backgroundConnexion">
    ...
    <br />
    <p>Vous trouverez sur ce site de nombreuses histoires interactives : des histoires dont vous êtes le héros ou l'héroïne ! Sélectionnez une histoire parmi celles écrites par nos membres, et plongez dans un récit sur-mesure, dont l'issue dépend de vos décisions.</p>
    <br />
    <hr />
    <div>
      <?php
